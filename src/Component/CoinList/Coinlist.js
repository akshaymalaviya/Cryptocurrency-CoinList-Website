...
export default function Coinlist() {
  ...
  const FetchCoinListRequest_option = async () => {
    let CoinListURL = `https://coingecko.p.rapidapi.com/coins/markets?vs_currency=usd&page=${urlParams.get(
      'page'
  ...
  return (
    <div className="CoinlistData" style={CoinList}>
      ...
      <div className="CoinListDiv" id="CoinListScollDiv" style={CoinListDiv}>
        <div className="CList">
          <div className="CList_Option" style={CList_Option}>
            ...
            <h6
              ...
              style={CList_Option_text}
              onMouseOut={OptionRemoveHover}
        ...
        <div className="PriceByMarket_Title" style={MarketCapTitle}>
        ...
        <div className="AllCoin" id="AllCoinDiv" style={coinList}>
          ...
          <div className="Particular_coin" style={ParticularCoin_title}>
            <div className="CoinIndex" style={CoinIndex_title}>
              #
            </div>

            <div className="CoinName" style={CoinName_title}>
              Coin
            </div>

            <div className="CoinRank" style={CoinRank_title}>
              Rank
            </div>

            <div className="CoinPrice" style={CoinPrice_title}>
              Price
            </div>

            <div className="24High" style={CoinHigh_title}>
              24h High
            </div>

            <div className="25Low" style={CoinHigh_title}>
              24h Low
            </div>

            <div className="MarketCap" style={CoinHigh_title}>
              Mkt Cap
            </div>
          </div>
          ...
          {CoinData.map((element) => {
            ...
            return (
              ...
              <div
                className="Particular_coin"
                style={ParticularCoin}
                onMouseOver={HoverEffect}
                onMouseOut={HoverRemove}
              >
                {/* CoinIndex  */}

                <div className="CoinIndex" style={CoinIndex}>
                  {CoinStartIndex}
                </div>
                ...
                <div className="CoinRank" style={CoinRank}>
                  {element.market_cap_rank}
                </div>

                {/* Coin Price  */}

                <div className="CoinPrice" style={CoinPrice}>
                  ${IndianNumberFormat.format(element.current_price)}
                </div>

                {/* 24hour max price   */}

                <div className="24High" style={CoinHigh}>
                  ${IndianNumberFormat.format(element.high_24h)}
                </div>

                {/* 24Hour low price  */}

                <div className="25Low" style={CoinLow}>
                  ${IndianNumberFormat.format(element.low_24h)}
                </div>

                {/* Market cap value  */}

                <div className="MarketCap" style={MarketCap}>
                  ${IndianNumberFormat.format(element.market_cap)}
                </div>
              </div>
            );
          })}
        ...
        <div className="Exchange" style={exchangeList}>
          ...
          <div className="ExchangeTitleRow" style={ParticularCoin_title}>
            <div className="ExchangeIndex" style={CoinIndex_title}>
              #
            </div>

            <div className="ExchangeName" style={ExchangeNameTitle}>
              Exchange name
            </div>

            <div className="ExchangeWebsite" style={WebsiteTitle}>
              Website
            </div>

            <div className="ExchangeRank" style={CoinRank_title}>
              Rank
            </div>

            <div className="ExchangeBTCvolume" style={CoinHigh_title}>
              24H BTC volume
            </div>
          </div>
          ...
          {exchangeData.length != 0 ? (
            exchangeData.map((element) => {
              ...
              return (
                ...
                <div
                  className="ExchangeDiv"
                  style={ExchangeCoinDiv}
                  onMouseOver={HoverEffect}
                  onMouseOut={HoverRemove}
                >
                  {/* ExchangeList Index  */}

                  <div className="ExchangeIndex" style={CoinIndex}>
                    {ExchangeStartIndex}
                  </div>
                  ...
                  <div className="ExchangeIImageName" style={CoinImageName}>
                    <img
                      ...
                      src={element.image}
                    ></img>
                    <div className="ExchangeName" style={CoinName}>
                      {element.name}
                    </div>
                  </div>
                  ...
                  <div className="ExchangeWebsite" style={WebsiteData}>
                    <i
                      ...
                      onClick={() => openExchangeWebsite(element.url)}
                    ></i>
                  </div>

                  {/* Exchange Rank  */}

                  <div className="ExchangeRank" style={CoinRank}>
                    {element.trust_score_rank}
                  </div>

                  {/* Exchange 24H BTC volume Information  */}

                  <div className="ExchangeBTCvolume" style={MarketCap}>
                    ${IndianNumberFormat.format(element.trade_volume_24h_btc)}
                  </div>
                </div>
              );
            })
